 ...
 * Individual Homework and Team Project assignments. </p>
 *
...
public class FoundationsMain extends Application {
	...
	/**
	 * Default constructor for FoundationsMain.
	 */
	...
	/** Fixed reference to the database for the rest of the application. */
	public static Database database = new Database();
	
    private Alert databaseInUse = new Alert(AlertType.INFORMATION);

	/** Which role's home page is currently active (Role 0 is the admin). */
	public static int activeHomePage = 0;		
	
	/**
	 * Starts the JavaFX application by connecting to the database and 
	 * determining the initial view.
