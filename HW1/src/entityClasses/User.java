...
public class User {
     ...
     * @param r1 specifies the Admin attribute
     * @param r2 specifies the Staff attribute
     * @param r3 specifies the Student attribute
     */
    ...
    /**
     * Sets the first name.
     * @param s the first name to set
     */
    public void setFirstName(String s) { firstName = s; }
    
    /**
     * Sets the middle name.
     * @param s the middle name to set
     */
     ...
     * @param s the preferred first name to set
     */
