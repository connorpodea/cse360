 ...
 * This class supports the actions initiated by the ViewUserUpdate class.
 */
public class ControllerUserUpdate {
	
	/**
	 * Default constructor for ControllerUserUpdate.
	 */
	...
	/**
	 * This method is called when the user has clicked on the button to proceed to the user's home page.
	 ...
	 * their username on the User Update page (or other pages).  It uses the shared
