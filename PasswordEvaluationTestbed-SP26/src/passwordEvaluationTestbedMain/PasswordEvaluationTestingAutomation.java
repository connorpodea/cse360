...
public class PasswordEvaluationTestingAutomation {
	...
	private static void displayEvaluation() {
		...
		if (passwordPopUpWindow.Model.foundLongEnough && passwordPopUpWindow.Model.foundShortEnough)
			System.out.println("Between 8 and 32 characters - Satisfied");
		else
			System.out.println("Between 8 and 32 characters - Not Satisfied");
	}
}
