...
public class View {
	...
	public static void view (Pane theRoot) {
	    ...
	    setupLabelWidget(label_UpperCase, 30, 160, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);

	    setupLabelWidget(label_LowerCase, 30, 190, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_NumericDigit, 30, 220, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_SpecialChar, 30, 250, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_LongEnough, 30, 280, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_ShortEnough, 30, 310, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	...
	static protected void resetAssessments() {
	    ...
	    label_ShortEnough.setText("At most 32 characters - Satisfied");
